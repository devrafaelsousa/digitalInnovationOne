...
import parte01.poo.java.encapsulamento.exemplo.exemplo1.Carro;
import parte01.poo.java.encapsulamento.exemplo.exemplo1.Veiculo;

public class Exemplo02 {

    public static void main(String[] args) {
        parte01.poo.java.encapsulamento.exemplo.exemplo1.Veiculo carro1 = new Carro( "Palio", "Fiat", 20000.0);
