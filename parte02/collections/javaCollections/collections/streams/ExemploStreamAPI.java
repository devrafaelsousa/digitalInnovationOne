package parte02.collections.javaCollections.collections.streams;
...
public class ExemploStreamAPI {
    ...
    public static void main(String[] args) {
        ...
        // Retorna cada elemento no console sem retornar outra coleção
        System.out.println("Retorna os elementos novamente: ");
        estudantes.stream().forEach(System.out::println);

        // Retorna true se todas os elementos possuem a letra W no nome
        System.out.println("Todos os elemento tem W no nome? " + estudantes.stream().allMatch((elemento) -> elemento.contains("W")));

        // Retorna true se todas os elementos possuem a letra A minuscula no nome
        ...
        System.out.println(estudantes.stream()
                .peek(System.out::println).map(estudante ->
